...
export const Spotlight = () => {
  ...
  return (
    <>
      <div className=" md:px-36 py-10 px-5 md:h-[700px] bg-[#FFF6F3] flex flex-col justify-center  relative">
        <div className={` ${ showVideo ? "absolute" : "hidden" } md:h-[700px] bg-[#16161691] p-10 w-screen flex justify-center items-center`} onClick={()=>setShowVideo(!showVideo)}>
        <iframe width="600" height="400"  src="https://www.youtube.com/embed/KnGfIXDNNNk?si=JMPYreVsxpD-P7Ff" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
        <div>
